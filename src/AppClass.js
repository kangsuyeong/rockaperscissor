  ...
  render() {
    return (
      <div>
        ...
        <div className="main">
        <button className="button-size" onClick={() => this.play("scissors")}><img className="button-img" src="images/scissors2.jpg"></img></button>
        <button className="button-size" onClick={() => this.play("rock")}><img className="button-img" src="images/rock2.jpg"></img></button>
        <button className="button-size" onClick={() => this.play("paper")}><img className="button-img" src="images/paper2.jpg"></img></button>
      </div>
      </div>
    );
  }
